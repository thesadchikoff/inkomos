        ...
        <div id={"about-us-section"} className={"w-full flex-1 relative"}>
           ...
           <div className={"w-full h-full relative"}>
            ...
            <div id={"advantages-section"} className={"w-full relative bottom-[250px] flex mobile:px-2 tablet:px-10 desktop:px-10 flex-col tablet:items-center desktop:items-center gap-[30px]"}>
                ...
                <button className={"flex items-center gap-[6px] text-purple-400 text-base font-semibold"}>Начать с
                    нами <FaArrowRightLong/></button>
                ...
                <Table>
                    <Table.Group>
                        ...
                        <Table.Item item={<span
                            className={"text-white text-base font-semibold flex items-center gap-[6px] justify-end"}>Подробнее <FaArrowRightLong/></span>}/>
                    </Table.Group>
                    <Table.Group>
